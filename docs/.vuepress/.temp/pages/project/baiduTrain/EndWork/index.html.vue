<template><div><h1 id="结课作业-实现一个简单的-mvvm-框架" tabindex="-1"><a class="header-anchor" href="#结课作业-实现一个简单的-mvvm-框架" aria-hidden="true">#</a> 结课作业：实现一个简单的 MVVM 框架</h1>
<h2 id="基本要求" tabindex="-1"><a class="header-anchor" href="#基本要求" aria-hidden="true">#</a> 基本要求</h2>
<ul>
<li><RouterLink to="/project/baiduTrain/EndWork/01-%E5%AD%A6%E4%B9%A0%E6%95%B0%E6%8D%AE%E5%8A%AB%E6%8C%81/%E4%BD%BF%E7%94%A8Proxy%E5%AE%9E%E7%8E%B0%E6%95%B0%E6%8D%AE%E5%8A%AB%E6%8C%81.html">实现数据劫持</RouterLink></li>
<li><RouterLink to="/project/baiduTrain/EndWork/02-%E5%AD%A6%E4%B9%A0%E5%8F%91%E5%B8%83%E8%AE%A2%E9%98%85%E6%A8%A1%E5%BC%8F/%E5%8F%91%E5%B8%83%E8%AE%A2%E9%98%85%E6%A8%A1%E5%BC%8F.html">实现发布订阅模式</RouterLink></li>
<li><RouterLink to="/project/baiduTrain/EndWork/03-%E5%AD%A6%E4%B9%A0%E6%95%B0%E6%8D%AE%E5%8D%95%E5%90%91%E7%BB%91%E5%AE%9A/%E5%8D%95%E5%90%91%E7%BB%91%E5%AE%9A.html">实现数据单向绑定</RouterLink></li>
<li><RouterLink to="/project/baiduTrain/EndWork/04-%E5%AD%A6%E4%B9%A0%E5%8F%8C%E5%90%91%E7%BB%91%E5%AE%9A/%E5%8F%8C%E5%90%91%E7%BB%91%E5%AE%9A.html">实现双向绑定</RouterLink></li>
</ul>
<p>要实现一个 MVVM 框架, 还得有：</p>
<ul>
<li>渲染系统模块</li>
<li>应用程序入口模块</li>
</ul>
<p>ps：本项目参考Vue3来实现</p>
<h2 id="前言-mvvm-模式" tabindex="-1"><a class="header-anchor" href="#前言-mvvm-模式" aria-hidden="true">#</a> 前言：MVVM 模式</h2>
<p>在开始项目前，我们需要先了解一下MVVM，得先知道什么是MVVM， MVVM 与我们平时经常使用 Vue 有什么区别。</p>
<ol>
<li>
<p>什么是MVVM呢？<br>
MVVM 其实是一种思想，是一种生成模式。MVVM 表示的是 View-ViewModel-Model，就是视图层-视图模型层-模型层。View是作为视图层，简单来说可以把它理解为HTML页面；Model 是作为模型层，它是负责处理业务逻辑以及和服务器端进行交互的；ViewModel 是作为视图模型层，也就是 Vue 框架所起到的作用了，主要是作为 View 层和 Model 层之间的通信桥梁。<br>
<img src="https://cdn.jsdelivr.net/gh/jsdevin/imgBed/img/202207192320672.png" alt="mvvm作用过程"></p>
</li>
<li>
<p>vue 和 MVVM 的关系<br>
MVVM 的设计思想是关注 Model 的变化，让 MVVM 框架去自动更新 DOM 的状态，从而把开发者从操作 DOM 的繁琐步骤中解脱出来。<br>
我们可以发现 vue 是符合 mvvm 的设计思想的。 Vue 将视图层 View 和模型层 Model 有效地分离开来，让我们只需要关心数据即可。基于这一点，<strong>Vue 框架就是充当了 MVVM 开发模式中的 ViewModel 层</strong>，负责 View 和 Model 之间通信的桥梁。我们在使用 Vue 框开发的时候，只需要关心 View 层的 HTML 代码和 Model 层的 JavaScript 逻辑就可以了。<br>
<img src="https://cdn.jsdelivr.net/gh/jsdevin/imgBed/img/202207200040761.png" alt="vue框架是ViewModel"></p>
</li>
</ol>
<p>参考文章： <a href="https://zhuanlan.zhihu.com/p/67960731" target="_blank" rel="noopener noreferrer">vue 与 mvvm 的关系<ExternalLinkIcon/></a></p>
<h2 id="渲染系统模块" tabindex="-1"><a class="header-anchor" href="#渲染系统模块" aria-hidden="true">#</a> 渲染系统模块</h2>
<p>在开始完成项目的四个基本要求之前，我们可以先完成渲染系统模块，该模块主要包含三个功能.</p>
<ul>
<li>功能一是 h()函数,用于返回虚拟节点vNode对象, 该对象包含三样东西tag, props, children.</li>
<li>功能二是 mount函数，用于将vNode挂载到DOM上</li>
<li>功能三是 patch函数，用于对两个vNode进行对比，决定如何处理新的VNode</li>
</ul>
<ol>
<li>
<p>h() 生成虚拟节点<br>
通过h()函数将传入的三个参数渲染成一个虚拟DOM节点返回，h()函数的第一个参数是代表着<strong>标签</strong>的tag, 第二个参数是代表着<strong>属性</strong>的props, 第三个参数是children，代表的是第一个参数tag标签的<strong>内容</strong>，当然这个内容也可以是子节点。<br>
<img src="https://cdn.jsdelivr.net/gh/jsdevin/imgBed/img/202207230009622.png" alt="h()的代码"></p>
</li>
<li>
<p>mount() 将虚拟节点按照children中父子关系挂载，形成虚拟DOM树<br>
mount()是挂载方法，其有两个参数，第一个参数vnode是需要被挂载的虚拟DOM节点，第二个参数是容纳第一个参数vnode(虚拟节点)的容器节点container．当所有的虚拟节点都按照各自children中的父子关系挂载好之后，就形成了虚拟DOM树。<br>
首先处理tag标签，利用h函数暴露出来的tag生成一个标签节点元素，并将元素存储到虚拟节点vnode中。<br>
然后处理props属性，如果是on开头，就监听事件，如果是普通的属性，就直接使用setAttribute来创建属性即可。<br>
最后处理children属性，如果是children是字符串，就直接设置textContent即可，如果是数组节点，就遍历调用mount函数，使其作为子节点挂载。<br>
<img src="https://cdn.jsdelivr.net/gh/jsdevin/imgBed/img/202207230012965.png" alt=""></p>
</li>
<li>
<p>patch(oldNode, newNode) 函数： 一个更新旧节点的函数. 实现思路如下</p>
</li>
</ol>
<ul>
<li>
<p>比较tag:<br>
如果旧节点含有的标签元素类型和新节点含有的标签元素类型不相同，直接删掉旧节点的标签，然后将新节点的标签添加进去即可。如果旧节点含有的标签元素和新节点含有的标签元素相同, 进行下一步</p>
</li>
<li>
<p>处理props:<br>
先将新节点的props属性全添加到旧节点，在添加的过程中遍历新节点的props，<br>
如果新节点的props的属性和旧节点的props属性含有一样的属性，但是二者的属性值不相同,那么我们就用setAttribute新建一个属性添加到老节点中，<br>
如果二者属性值相同,不做处理. 不需要考虑覆盖的的情况.只有相同的属性且其属性值也相同才保留,待全部添加完毕后,在旧节点中删除只存在于旧节点props但不存在于新节点props的属性, 剩下的都是patch处理之后的属性了</p>
</li>
<li>
<p>处理children:<br>
处理新节点的children需要先判断其类型,然后再进行处理,<br>
如果新节点的children是字符串,那就好办,直接使用innerHTML将字符串赋值给旧节点即可.无需考虑旧节点children的情况<br>
如果新节点的children是数组,就比较麻烦,我们就要依据旧节点的children的类型来进行处理<br>
    如果旧节点的children的类型是string, 简简单单,直接清空旧节点的children,然后挂载新节点的children即可(因为已知新节点的children为数组)<br>
    如果旧节点的children也是数组,此时新旧节点的children都是数组. 我们需要先判断新旧节点children的数组长度, 使用长度小的那个数组长度A作为遍历的判断停止条件, 来控制patch(oldchildren, newchildren)的执行次数.<br>
            A次执行patch(oldchildren, newchildren)执行完之后,剩下的children数组元素就是仅存于一方的children中了,<br>
            如果存在于新节点的children中(即newChildren.length &gt; oldChildren.length),就需要添加到旧节点中,添加方法就是直接遍历然后使用mount()挂载方法<br>
            如果存在于旧节点的children中(即newChildren.length &lt; oldChildren.length),就需要删去,删除方法就是直接遍历然后使用removeChild()挂载方法</p>
</li>
</ul>
<p>patch()实现代码:</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> <span class="token function-variable function">patch</span> <span class="token operator">=</span> <span class="token punctuation">(</span><span class="token parameter">oldNode<span class="token punctuation">,</span> newNode</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span>    
  ...
  <span class="token punctuation">}</span>    
<span class="token punctuation">}</span>    
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>渲染系统模块完成效果预览:<br>
<img src="https://cdn.jsdelivr.net/gh/jsdevin/imgBed/img/202207190205314.gif" alt=""></p>
<h2 id="响应式系统模块" tabindex="-1"><a class="header-anchor" href="#响应式系统模块" aria-hidden="true">#</a> 响应式系统模块</h2>
<p>数据劫持、发布订阅模式、单向绑定、双向绑定皆属于响应式系统模块的内容。</p>
<h3 id="响应式原理" tabindex="-1"><a class="header-anchor" href="#响应式原理" aria-hidden="true">#</a> 响应式原理</h3>
<p>在了解了mvvm模式之后，我们可以很清晰地了解到什么是响应式原理，响应式原理就是在改变数据的时候，视图会跟着更新。往大点说，响应系统是一种自动使数据源（模型）与数据表示（视图）层自动保持同步的机制。每次模型更改时，都会重新渲染视图。<br>
同时我们需要了解的是，响应式原理就是双向绑定原理，二者是同样的东西，只是叫法不同。</p>
<ul>
<li>补充：vue2、vue3 的响应式原理分布是什么？</li>
</ul>
<ol>
<li>
<p>在vue2中用Object.defineProperty()来实现响应式原理<br>
Vue2的实现原理 是通过 Object.defineProperty 来劫持各个属性的setter、getter，在数据变动时发布消息给订阅者，触发相应的监听回调。<br>
vue2使用Object.defineProperty来实现响应式原理有着许多缺陷，比如不能监听数组，也无法检测到对象属性的添加和删除，并且只有data对象中的属性才能转化为响应式。</p>
</li>
<li>
<p>在vue3中用Proxy来实现响应式原理<br>
Vue3中响应式原理就是当需要对某个对象操作时，会先生成一个代理对象，并且我们数据劫持时劫持到的也是代理对象，我们所有的操作都将会在代理对象中完成，然后返回。<br>
基于Proxy, 劫持的是一整个代理对象，并且Proxy提供了has()、deleteProperty等捕获器，可以非常轻易地去添加对象属性和删除对象属性。</p>
</li>
</ol>
<ul>
<li>思考： 为什么Vue3选择使用Proxy来实现响应式？<br>
（1）Object.definedProperty 是劫持对象的属性时，如果新增元素，那么Vue2需要再次 调用definedProperty，而 Proxy 劫持的是整个对象，不需要做特殊处理。这是Proxy的第一个优势<br>
（2）vue2使用Object.definedProperty，修改原本对象就能触发拦截，而Vue3使用Proxy，需要修改代理对象才能出发拦截，一切操作不通过原对象实现，这样子原对象就不会发生任何改变，保护了原对象。这是Proxy的第二个优势<br>
（3）Proxy 能观察的类型比 defineProperty 更丰富，Proxy有has()方法和deleteProperty()方法，他们分别是in操作符的捕获器和delete 操作符的捕捉器。这是Proxy的第三个优势</li>
</ul>
<p>参考文章：<br>
<a href="https://juejin.cn/post/6982001553540382733#heading-1" target="_blank" rel="noopener noreferrer">vue2、vue3响应式原理<ExternalLinkIcon/></a><br>
<a href="https://www.yisu.com/zixun/457735.html" target="_blank" rel="noopener noreferrer">什么是vue响应式系统？<ExternalLinkIcon/></a></p>
<h3 id="实现响应式系统模块" tabindex="-1"><a class="header-anchor" href="#实现响应式系统模块" aria-hidden="true">#</a> 实现响应式系统模块</h3>
<p>响应式系统模块的实现前需要先实现依赖收集系统，在没有考虑vue2的 Object.definedProperty 和vue3的 Proxy 的情况下，我们实现一个简单版的依赖收集模系统。</p>
<ol>
<li>
<p>简单版 - 依赖收集系统</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// 简易版的依赖收集系统  </span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>// 无论<code v-pre>info.counter++; info.name = &quot;why&quot;; foo.height = 2; </code>这三个执行哪一个，notify()都会去遍历所有的依赖，然后执行。这是缺陷<br>
// 因为对于多个对象，如果我们只是改变其中一个对象的属性，我们当然只希望去响应当前的对象即可，不需要去响应其它对象的依赖。<br>
// 比如上面的info对象和foo对象, 我们改变了foo.height属性,我们只需要foo对象对应的依赖响应即可,不需要去响应info对象的依赖.<br>
// 但是这里notify()的设计原理是对this.subscribers集合进行forEach()遍历, 无论是任何对象的任何属性发生改变,势必都会使得所有的依赖被遍历出来并执行.<br>
// 所以这个是不合格的, 需要继续完善.</p>
<p>// 打印结果:<br>
effect1: 200 why<br>
effect2: 10000<br>
...
effect4: 2</p>
<p>// 解析结果:<br>
// 前四行是在watchEffect()中执行effect()打印出来的原本的数据, 用作对比<br>
// 后四行是dep.notify()输出的响应结果</p>
<p>// 总结:<br>
// 简单的依赖收集系统的思路到此结束.<br>
// 存在的缺陷: 使用dep.notify()只会一股脑地输出集合中所有对象的所有依赖, 不能实现改变A对象的属性, 就响应A对象该属性依赖</p>
</li>
<li>
<p>vue2思想完善依赖收集系统 =&gt; 响应式系统<br>
添加下图这一块，实现响应式。基于 Object.defineProperty 劫持的是对象的某个属性，针对某个属性收集依赖，不影响到同一对象的其它属性，也不影响到其它对象。可以在文件中查看完整的源代码。</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// Map({key: value}): key是一个字符串  </span>
...
<img src="https://cdn.jsdelivr.net/gh/jsdevin/imgBed/img/202207200035016.png" alt="结果"></p>
</li>
<li>
<p>vue3思想完善依赖收集系统 =&gt; 响应式系统<br>
添加下图这一块，实现响应式。基于 Proxy 劫持的是整个对象。对对象进行操作都会引起劫持。</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// Map({key: value}): key是一个字符串  </span>
<span class="token comment">// WeakMap({key(对象): value}): key是一个对象, 弱引用, 方便设置为null进行垃圾回收  </span>
<span class="token keyword">const</span> targetMap <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">WeakMap</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// targetMap 用来存储所有对象的映射  </span>
...
<img src="https://cdn.jsdelivr.net/gh/jsdevin/imgBed/img/202207200037945.png" alt=""></p>
</li>
</ol>
<p>注意：这里的是vue响应式的核心代码，没有考虑边界情况，后续如果有机会回顾的话，可以考虑补充一下边界情况。</p>
<h2 id="应用程序入口模块" tabindex="-1"><a class="header-anchor" href="#应用程序入口模块" aria-hidden="true">#</a> 应用程序入口模块</h2>
<p>这一个模块的主要作用是将设置一个程序入口，将所有东西串联起来。createApp 会创建一个程序的开端，传入的参数是根组件，返回的结果是挂载好根组件的对象。</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">createApp</span><span class="token punctuation">(</span><span class="token parameter">rootComponent</span><span class="token punctuation">)</span> <span class="token punctuation">{</span> <span class="token comment">// rootComponent参数传入的是根组件  </span>
  ...
  <span class="token punctuation">}</span>  
<span class="token punctuation">}</span>  
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="测试此框架" tabindex="-1"><a class="header-anchor" href="#测试此框架" aria-hidden="true">#</a> 测试此框架</h2>
<p>测试样例：</p>
...
<p><img src="https://cdn.jsdelivr.net/gh/jsdevin/imgBed/img/202207222355808.gif" alt="测试结果"></p>
<h2 id="线上发布版本" tabindex="-1"><a class="header-anchor" href="#线上发布版本" aria-hidden="true">#</a> 线上发布版本</h2>
<p><a href="https://baidumvvm.devin.ren/" target="_blank" rel="noopener noreferrer">线上版本点击这里查看<ExternalLinkIcon/></a><br>
<a href="https://github.com/jsdevin/Mini-Vue3" target="_blank" rel="noopener noreferrer">源代码托管于github, 点击这里查看<ExternalLinkIcon/></a></p>
<p>本项目学习自互联网。</p>
</div></template>
