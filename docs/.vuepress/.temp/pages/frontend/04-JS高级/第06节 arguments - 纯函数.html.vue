...
<h2 id="为什么要有arguments" tabindex="-1"><a class="header-anchor" href="#为什么要有arguments" aria-hidden="true">#</a> 为什么要有arguments ？</h2>
<ul>
...
<div class="language-JavaScript ext-JavaScript line-numbers-mode"><pre v-pre class="language-JavaScript"><code>function fn(x,y) {
  ...
}
...
<h2 id="怎么运用arguments" tabindex="-1"><a class="header-anchor" href="#怎么运用arguments" aria-hidden="true">#</a> 怎么运用arguments ？</h2>
<ul>
...
<p>sum是纯函数；add不是纯函数，因为中途foo被改变了，那么同样的输入就得不到同样的输出。printInfo是纯函数。</p>
